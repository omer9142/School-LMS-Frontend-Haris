...
const initialState = {
    ...
    subjectsList: [],
    subjectDetails: [],
    unassignedStudents: [], // Added unassignedStudents array
    loading: false,
    subloading: false,
    error: null,
    response: null,
...
const sclassSlice = createSlice({
    ...
    reducers: {
        ...
        // New actions for unassigned students
        getUnassignedStudentsSuccess: (state, action) => {
            state.unassignedStudents = action.payload;
            state.loading = false;
            state.error = null;
        },
        clearUnassignedStudents: (state) => {
...
export const {
    ...
    getUnassignedStudentsSuccess, // Export new actions
    clearUnassignedStudents,      // Export new actions
} = sclassSlice.actions;
